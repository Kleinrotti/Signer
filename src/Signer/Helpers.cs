...
namespace Signer
{
    internal static class Helpers
    {
        ...
        public static async Task<Tuple<int, int, int>> SignWithFile(string certPath, string passphrase, IEnumerable<FileObject> files, Action<int, int> progressCallback, ParallelOptions parallelOptions, bool includeSigned = false, Hash hash = Hash.SHA256,
        ...
        /// <param name="timestampType"></param>
        /// <returns></returns>
        public static async Task<Tuple<int, int, int>> SignWithStore(string thumbprint, IEnumerable<FileObject> files, Action<int, int> progressCallback, ParallelOptions parallelOptions, bool includeSigned = false, Hash hash = Hash.SHA256,
            TimestampHash timestampHash = TimestampHash.SHA256, TimestampType timestampType = TimestampType.RFC3161)
        {
            int count = 0;
            int success = 0;
